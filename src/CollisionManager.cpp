...
bool CollisionManager::circleCircleCheck(GameObject* object1, GameObject* object2)
{
	float squaredDistance = Util::squaredDistance(object1->getTransform()->position, object2->getTransform()->position);
	// circle1
	//const auto circleCentre = object1->getTransform()->position;
	const float circle1Radius = object1->getWidth();
	// circle2
	//const auto circleCentre2 = object2->getTransform()->position;
	const float circleRadius2 = object2->getWidth();

	float totalRadius = circle1Radius + circleRadius2;
